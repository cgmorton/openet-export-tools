...
def main(
    ...
    if study_area_coll_id:
        ...
        #     )
        mgrs_ftr_coll = mgrs_ftr_coll.filterBounds(study_area_coll.geometry())
    ...
    for iter_start_date, iter_end_date in iter_dates:
        ...
        for month_img_id in month_image_list:
            ...
            image_info = output_img.getInfo()
            mgrs_tile = image_info['properties']['mgrs_tile']
            ...
            tif_name = tif_name_fmt.format(date=iter_start_dt.strftime('%Y%m%d'), mgrs=mgrs_tile,)

...
def main(
    ...
    """Export OpenET Monthly Reprojected Images to a Google Cloud Storage Bucket
    ...
    for iter_start_date, iter_end_date in iter_dates:
        ...
        export_name = tif_name_fmt.format(date=iter_start_dt.strftime('%Y%m%d'))
        ...
        # TODO: Need a composite properties JSON for this to work correctly
